...
use CicloMenstrual\Domain\MenstrualCalendar\Entities\Dtos\PhaseData;
use DateTimeImmutable;
use PHPUnit\Framework\TestCase;

class PhaseDataTest extends TestCase
{

    private PhaseData $instance;
    ...
    {
        $this->instance = new PhaseData($this->initialDate, $this->endDate);
    }
